                    ...
                    <template v-slot:preview>
                        ...
                        <div>
                            <b-form @submit="onSubmit" @reset="onReset" v-if="show">
                                ...
                                <b-form-group label="Upload Logo:" label-cols-sm="2">
                                ...
                                <b-form-group id="input-group-2" label="Nama Ketua:" label-for="input-2">
                                    <b-form-input id="input-2" v-model="form.name" required placeholder="Enter Caption">
                                    </b-form-input>
                                </b-form-group>
                                <b-form-group id="input-group-2" label="Nama Pembina:" label-for="input-2">
                                    <b-form-input id="input-2" v-model="form.name" required placeholder="Enter Caption">
                                    </b-form-input>
                                </b-form-group>
                                <b-form-group id="input-group-2" label="Contact Person:" label-for="input-2">
                                    <b-form-input id="input-2" v-model="form.name" required placeholder="Enter Caption">
                                    </b-form-input>
                                </b-form-group>
                                <b-form-group label="Upload Galeri:" label-cols-sm="2">
                                    <b-form-file id="file-default"></b-form-file>
                                </b-form-group>
