  ...
  routes: [
    {
      ...
      children: [
        ...
        },
        {
          path: "/viewfile",
          name: "viewfile",
          component: () => import("@/view/pages/Viewfile.vue")
        },
        {
          path: "/uploadevent",
          name: "uploadevent",
          component: () => import("@/view/pages/UploadEvent.vue")
        },
        {
          path: "/addukm",
          name: "addukm",
          component: () => import("@/view/pages/AddUkm.vue")
        },
        {
          path: "/home",
          name: "home",
        ...
        },
        {
          path: "/profil",
          name: "profil",
          component: () => import("@/view/pages/profil.vue")
        },
        {
          path: "/ukmdance",
          name: "ukmdance",
          component: () => import("@/view/pages/menu-profil/ukmdance.vue")
        },
        {
          path: "/ukmmusik",
          name: "ukmmusik",
          component: () => import("@/view/pages/menu-profil/ukmmusik.vue")
        },
        {
          path: "/ukmmapala",
          name: "ukmmapala",
          component: () => import("@/view/pages/menu-profil/ukmmapala.vue")
        },
        {
          path: "/ukmesprime",
          name: "ukmesprime",
          component: () => import("@/view/pages/menu-profil/ukmesprime.vue")
        },
        {
          path: "/builder",
          name: "builder",
